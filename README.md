...
**Download.** The mini-MusicNet dataset can be downloaded [here](https://drive.google.com/drive/folders/10Cz6As5hiFkRZKA3hrv9qBH5tn0OC3H1?usp=sharing). To follow the tutorial in the next section or run ``explore.ipynb``, please download mini-MusicNet to the ``minimusic`` sub-directory of the root of this repository.
